...
There are few things that we need to clean up in the dataset.

The species_id is missing in some records. Let's remove those.
...
There are many species with low counts, let's remove the ones below 10 counts
